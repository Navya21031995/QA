...
public class Agriculture_Crops {
	...
	SoftAssert Assert;
		...
		public Agriculture_Crops(WebDriver driver){
		...
		@FindBy(xpath="//ul[@class='col-sm-4 list-unstyled']//a[text()='"+Const.CROPS_SUB_MENU+"']")
		WebElement Crops;
		...
		WebElement assetTypeOfCropDropdown;   
		...
		public void addAsset(String Facility, String Activity, String Variable,String TypeOfCrop, String Unit) throws InterruptedException{
			...
			Thread.sleep(5000);
			CommonMethods.select(assetTypeOfCropDropdown, TypeOfCrop);
			Thread.sleep(5000);
...
//			CommonMethods.clickOn(cancelButton);
		...
		public void assetSaveCancelButton(String Facility, String Variable, String Activity,String TypeOfCrop, String Hub) throws InterruptedException {
			...
			if(this.alertPopUpOKButton.isDisplayed()){ 
				...
				CommonMethods.select(typeOfCropDropdown, TypeOfCrop);
		...
		public void dataEntry(String From, String To, String Quantity, String Activity,String TypeOfCrop, String Hub,String Facility,String Variable) throws InterruptedException{
			...
			Const.logger.info("Data Entry is completed for Crops.");
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is completed for Crops.");			
			}
			else {
		...
		public void updateNVerifyData(String ExistFrom, String ExistTo,String Quantity,String From, String To, String Activity,String TypeOfCrop,String Hub,String Facility,String Variable) throws InterruptedException {
		...
		public void dataDelete(String Activity,String TypeOfCrop, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Data Entry is deleted for Crops.");
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is deleted for Crops.");			
			}
			else {
				Const.logger.info("Asset data does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset data does not exist.");				
		...
		public void assetDelete(String Activity,String TypeOfCrop, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			CommonMethods.clickOn(alertPopUpOKButton);
			//driver.navigate().refresh();
			Const.logger.info("Asset is deleted succcessfully for Crops.");
			ReportUtils.test.log(LogStatus.INFO, "Asset is deleted succcessfully for Crops.");			
			}
			else {
				Const.logger.info("Asset does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset does not exist.");				
