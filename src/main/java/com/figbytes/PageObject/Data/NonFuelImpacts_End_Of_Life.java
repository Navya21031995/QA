...
public class NonFuelImpacts_End_Of_Life {
	...
	SoftAssert Assert;
		...
		public NonFuelImpacts_End_Of_Life(WebDriver driver){
		...
		@FindBy(xpath="//ul[@class='col-sm-4 list-unstyled']//a[text()='"+Const.END_OF_LIFE_SUB_MENU+"']")
		WebElement EndOfLife;
		...
		WebElement EndOfLifeTypeDropdown;
		...
		WebElement assetEndOfLifeTypeDropdown; 
		...
		public void addAsset(String Facility, String Activity, String Variable,String EndOfLifeType,String ActivityUsage, String EmissionSource, String Unit) throws InterruptedException{
			...
			CommonMethods.clickOn(EndOfLife);	
			Thread.sleep(5000);
			...
			Thread.sleep(5000);
			CommonMethods.select(assetEndOfLifeTypeDropdown, EndOfLifeType);
...
//			CommonMethods.clickOn(cancelButton);
		...
		public void assetSaveCancelButton(String Facility, String Variable, String Activity,String EndOfLifeType,String ActivityUsage, String EmissionSource, String Hub) throws InterruptedException {
			...
			if(this.alertPopUpOKButton.isDisplayed()){ 
				...
				CommonMethods.select(EndOfLifeTypeDropdown, EndOfLifeType);
		...
		public void dataEntry(String From, String To, String Quantity, String Activity,String EndOfLifeType,String ActivityUsage, String EmissionSource, String Hub,String Facility,String Variable) throws InterruptedException{
			...
			Const.logger.info("Data Entry is completed for End of Life.");
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is completed for End of Life.");
			}
			else {
		...
		public void updateNVerifyData(String ExistFrom, String ExistTo,String Quantity,String From, String To, String Activity,String EndOfLifeType,String ActivityUsage, String EmissionSource,String Hub,String Facility,String Variable) throws InterruptedException {
		...
		public void dataDelete(String Activity,String EndOfLifeType,String ActivityUsage, String EmissionSource, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			ReportUtils.test.log(LogStatus.PASS, alertMsg);
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Data Entry is deleted for End Of Life.");
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is deleted for End of Life.");
			}
			else {
				Const.logger.info("Asset data does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset data does not exist.");
		...
		public void assetDelete(String Activity,String EndOfLifeType,String ActivityUsage, String EmissionSource, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			ReportUtils.test.log(LogStatus.PASS, alertMsg);
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Asset is deleted succcessfully for End Of Life.");
			ReportUtils.test.log(LogStatus.INFO, "Asset is deleted successfully for End of Life.");
			}
			else {
				Const.logger.info("Asset does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset does not exist.");
