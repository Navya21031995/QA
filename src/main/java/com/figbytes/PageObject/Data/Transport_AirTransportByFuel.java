...
public class Transport_AirTransportByFuel {
	...
	SoftAssert Assert;
		...
		public Transport_AirTransportByFuel(WebDriver driver){
		...
		@FindBy(xpath="//ul[@class='col-sm-4 list-unstyled']//a[text()='"+Const.AIR_TRANSPORT_BY_FUEL_SUB_MENU+"']")
		WebElement airTransportByFuel;
		...
		@FindBy(id="ddlAircraftType")
		WebElement aircraftTypeDropdown; 

		@FindBy(id="ddlFuelSubType")
		...
		@FindBy(xpath="//div[@id='tblCarbonEmissionData']//table//th[11]//a[@class='k-grid-filter']")
		WebElement fromDateFilter;
		
		@FindBy(xpath="//div[@id='tblCarbonEmissionData']//table//th[12]//a[@class='k-grid-filter']")
		WebElement toDateFilter;
		
		@FindBy(xpath=CommonLocators.DATE_FILTER_TEXT_BOX)
		WebElement dateFilterTextBox;
		
		@FindBy(xpath="//div[@id='tblDataAdd']//table//th[5]//a[@class='k-grid-filter']")
		...
		@FindBy(xpath="//div[@id='tblCarbonEmissionData']//table//th[5]//a[@class='k-grid-filter']")
		...
		public void addAsset(String Facility, String Activity, String Variable,String AircraftType,String FuelSubType, String Unit) throws InterruptedException{
			...
			CommonMethods.clickOn(airTransportByFuel);	
			Thread.sleep(5000);
			...
			Thread.sleep(5000);
			CommonMethods.select(aircraftTypeDropdown, AircraftType);
...
//			CommonMethods.clickOn(cancelButton);			
		...
		public void assetSaveCancelButton(String Facility, String Variable,String Activity,String AircraftType,String FuelSubType, String Hub) throws InterruptedException {
			...
			if(this.alertPopUpOKButton.isDisplayed()){ 
				...
				CommonMethods.select(aircraftType, AircraftType);
		...
		public void dataEntry(String From, String To, String Quantity, String Activity,String AircraftType,String FuelSubType, String Hub,String Facility,String Variable) throws InterruptedException{
			...
			Const.logger.info("Data Entry is completed for Air transport by fuel.");
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is completed for Air transport by fuel.");
			}
			else {
		...
		public void updateNVerifyData(String ExistFrom, String ExistTo,String Quantity,String From, String To, String Activity,String AircraftType,String FuelSubType, String Hub,String Facility,String Variable) throws InterruptedException {
		...
		public void dataDelete(String Activity,String AircraftType,String FuelSubType, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			ReportUtils.test.log(LogStatus.PASS, alertMsg);
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Data Entry is deleted for Air Transport by Fuel.");
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is deleted for Air Transport by Fuel.");
			}
			else {
				Const.logger.info("Asset data does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset data does not exist.");
		...
		public void assetDelete(String Activity,String AircraftType,String FuelSubType, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			ReportUtils.test.log(LogStatus.PASS, alertMsg);
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Asset is deleted succcessfully for Air Transport by Fuel.");
			ReportUtils.test.log(LogStatus.INFO, "Asset is deleted succcessfully for Air Transport by Fuel.");
			}
			else {
				Const.logger.info("Asset does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset does not exist.");
