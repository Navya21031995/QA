...
public class Agriculture_Forestry {
	...
	SoftAssert Assert;
		...
		public Agriculture_Forestry(WebDriver driver){
		...
		@FindBy(xpath="//ul[@class='col-sm-4 list-unstyled']//a[text()='"+Const.FORESTRY_SUB_MENU+"']")
		WebElement Forestry;
		...
		@FindBy(xpath="//div[@id='tblDataAddAgriculture']//tr[1]/td//input[contains(@id,'txtDateFrom_')]")
		WebElement dateFromText;
				
		@FindBy(xpath="//div[@id='tblDataAddAgriculture']//tr[1]/td//input[contains(@id,'txtDateTo_')]")
		WebElement dateToText;
		
		@FindBy(xpath="//div[@id='tblDataAddAgriculture']//tr[1]/td//input[contains(@id,'txtQuantity_')]")
		WebElement quantityText;
		
		@FindBy(xpath="//div[@id='tblDataAddAgriculture']//tr[1]/td//input[contains(@id,'txtNotes_')]")
		WebElement notesText;
		
		@FindBy(xpath="//div[@id='tblDataAddAgriculture']//tr[1]/td//i[contains(@id,'btnSave_')]")
		...
		@FindBy(xpath="//div[@id='tblDataShowAgriculture']//tr[1]/td//label[@id[contains(.,'lblDateFromEdit')]]")
		WebElement expectedDateFrom;
		
		@FindBy(xpath="//div[@id='tblDataShowAgriculture']//tr[1]/td//label[@id[contains(.,'lblDateToEdit')]]")
		WebElement expectedDateTo;
		
		@FindBy(xpath="//div[@id='tblDataShowAgriculture']//tr[1]/td//label[@id[contains(.,'lblQuantityEdit')]]")
		WebElement expectedQty;
		
		@FindBy(xpath="//div[@id='tblDataShowAgriculture']//tr[1]/td//i[contains(@id,'btnEdit_')]")
		WebElement editButton;
		
		@FindBy(xpath="//div[@id='tblDataShowAgriculture']//tr[1]/td//input[contains(@id,'txtDateFromEdit_')]")
		WebElement editDateFromTextBox;
		
		@FindBy(xpath="//div[@id='tblDataShowAgriculture']//tr[1]/td//input[contains(@id,'txtDateToEdit_')]")
		WebElement editDateToTextBox;
		
		@FindBy(xpath="//div[@id='tblDataShowAgriculture']//tr[1]/td//input[contains(@id,'txtQuantityEdit_')]")
		WebElement editQty;
		
		@FindBy(xpath="//div[@id='tblDataShowAgriculture']//tr[1]/td//input[@id[contains(.,'txtNotesEdit_')]]")
		WebElement editNotesText;
		
		@FindBy(xpath="//div[@id='tblDataShowAgriculture']//tr[1]/td//i[contains(@id,'btnEditSave_')]")
		...
		WebElement assetCategoryDropdown; 

		@FindBy(id=CommonLocators.ADD_ASSET_DROPDOWN_2)
		WebElement assetTypeDropdown; 

		@FindBy(id=CommonLocators.ADD_ASSET_DROPDOWN_3)
		WebElement assetAgeDropdown;  
		...
		@FindBy(xpath="//div[@id='tblDataShowAgriculture']//tr[1]/td//label[contains(@for,'chkAllArchive_')]")
		WebElement archiveCheckbox;
		
		@FindBy(xpath="//div[@id='tblDataShowAgriculture']//tr[1]/td//label[contains(@for,'chkAllDelete_')]")
		...
		@FindBy(xpath="//div[@id='tblDataShowAgriculture']//table//th[7]//a[@class='k-grid-filter']")
		...
		@FindBy(xpath="//div[@id='tblDataAddAgriculture']//tr[1]/td//label[contains(@for,'chkAllDeleteAsset_')]")
		WebElement deleteAssetCheckBox;
		
		@FindBy(id=CommonLocators.ASSET_DELETE_BUTTON)
		WebElement deleteAssetButton;
	
		@FindBy(xpath="//div[@id='tblDataShowAgriculture']//table//th[10]//a[@class='k-grid-filter']")
		WebElement fromDateFilter;
		
		@FindBy(xpath="//div[@id='tblDataShowAgriculture']//table//th[11]//a[@class='k-grid-filter']")
		WebElement toDateFilter;
		
		@FindBy(xpath=CommonLocators.DATE_FILTER_TEXT_BOX)
		WebElement dateFilterTextBox;
		
		@FindBy(xpath="//div[@id='tblDataAddAgriculture']//table//th[4]//a[@class='k-grid-filter']")
		WebElement dataAddEnteredAt;
		
		@FindBy(xpath= "//div[@id='tblDataAddAgriculture']//table//th[7]//a[@class='k-grid-filter']")
		WebElement dataEntryVariableFilter;
		
		@FindBy(xpath="//div[@id='tblDataAddAgriculture']//tr[1]//td//a[@class='clsInputControl']")
		WebElement expectedVariableAsset;
			
		@FindBy(how=How.XPATH, using =  "//div[@id='tblDataAddAgriculture']//tr//td[7]")
		List<WebElement> assetsAddTable;
		
		@FindBy(xpath="//div[@id='tblDataShowAgriculture']//table//th[4]//a[@class='k-grid-filter']")
		WebElement dataShowEnteredAt;
		
		@FindBy(how=How.XPATH, using = "//div[@id='tblDataShowAgriculture']//tr//td[7]" )
		List<WebElement> assetsShowTable;
		
		public void addAsset(String Facility, String Activity, String Variable,String Category,String Type, String Age, String Unit) throws InterruptedException{
			...
			CommonMethods.clickOn(Forestry);	
			Thread.sleep(5000);
			...
			Thread.sleep(5000);
			CommonMethods.select(assetCategoryDropdown, Category);
			CommonMethods.select(assetTypeDropdown, Type);
			Thread.sleep(5000);
			CommonMethods.select(assetAgeDropdown, Age);
			Thread.sleep(5000);			
...
//			CommonMethods.clickOn(cancelButton);
		...
		public void assetSaveCancelButton(String Facility, String Variable, String Activity,String Category,String Type, String Age, String Hub) throws InterruptedException {
			...
			if(this.alertPopUpOKButton.isDisplayed()){ 
				...
				CommonMethods.select(typeDropdown, Type);
				CommonMethods.select(ageTypeDropdown, Age);
		...
		public void dataEntry(String From, String To, String Quantity, String Activity,String Category,String Type, String Age, String Hub,String Facility,String Variable) throws InterruptedException{
			...
			Const.logger.info("Data Entry is completed for Forestry.");	
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is completed for Forestry.");
			}
			else {
		...
		public void updateNVerifyData(String ExistFrom, String ExistTo,String Quantity,String From, String To, String Activity,String Category,String Type, String Age,String Hub,String Facility,String Variable) throws InterruptedException {
		...
		public void dataDelete(String Activity,String Category,String Type, String Age, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			ReportUtils.test.log(LogStatus.PASS, alertMsg);
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Data Entry is deleted for Forestry.");
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is deleted for Forestry.");
			}
			else {
				Const.logger.info("Asset data does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset data does not exist.");
		...
		public void assetDelete(String Activity,String Category,String Type, String Age, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			ReportUtils.test.log(LogStatus.PASS, alertMsg);
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Asset is deleted succcessfully for Forestry.");
			ReportUtils.test.log(LogStatus.INFO, "Asset is deleted succcessfully for Forestry");
			}
			else {
				Const.logger.info("Asset does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset does not exist.");
