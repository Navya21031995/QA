...
//	private WebDriverWait wait10;
	...
	SoftAssert Assert;
		...
		public Transport_Rail(WebDriver driver){
...
//		    this.wait10 = new WebDriverWait(driver, 10);
		...
		@FindBy(xpath="//ul[@class='col-sm-4 list-unstyled']//a[text()='"+Const.RAIL_SUB_MENU+"']")
		WebElement Rail;
		...
		@FindBy(xpath="//div[@id='tblDataShowTransport']//table//th[10]//a[@class='k-grid-filter']")
		WebElement fromDateFilter;
		
		@FindBy(xpath="//div[@id='tblDataShowTransport']//table//th[11]//a[@class='k-grid-filter']")
		...
		@FindBy(xpath="//div[@id='tblDataShowTransport']//table//th[2]//a[@class='k-grid-filter']")
		...
		public void addAsset(String Facility, String Activity, String Variable,String MobileSource,String MobileType, String Unit ) throws InterruptedException{
...
//			CommonMethods.clickOn(cancelButton);
			...
			public void assetSaveCancelButton( String Facility,String Variable, String Activity,String MobileSource,String MobileType,String Hub) throws InterruptedException {
			...
			public void dataEntry(String From, String To, String Quantity, String Activity,String MobileSource,String MobileType,String Hub,String Facility, String Variable) throws InterruptedException{
				...
				Const.logger.info("Data Entry is completed for Rail.");	
				ReportUtils.test.log(LogStatus.INFO, "Data Entry is completed for Rail.");
				}
				else {
		...
		public void updateNVerifyData(String ExistFrom, String ExistTo,String Quantity,String From, String To, String Activity,String MobileSource,String MobileType,String Hub,String Facility, String Variable) throws InterruptedException {
		...
		public void dataDelete(String Activity,String MobileSource,String MobileType, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			ReportUtils.test.log(LogStatus.PASS, alertMsg);
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Data Entry is deleted for Rail.");
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is deleted for Rail.");
			}
			else {
				Const.logger.info("Asset data does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset data does not exist.");
		...
		public void assetDelete(String Activity,String MobileSource,String MobileType, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			ReportUtils.test.log(LogStatus.PASS, alertMsg);
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Asset is deleted succcessfully for Rail.");
			ReportUtils.test.log(LogStatus.INFO, "Asset is deleted succcessfully for Rail.");
			}
			else {
				Const.logger.info("Asset does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset does not exist.");
