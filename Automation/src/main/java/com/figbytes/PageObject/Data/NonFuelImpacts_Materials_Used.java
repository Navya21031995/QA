...
public class NonFuelImpacts_Materials_Used {
	...
	SoftAssert Assert;
		...
		public NonFuelImpacts_Materials_Used(WebDriver driver){
		...
		@FindBy(xpath="//ul[@class='col-sm-4 list-unstyled']//a[text()='"+Const.MATERIALS_USED_SUB_MENU+"']")
		WebElement MaterialsUsed;
		...
		WebElement materialTypeDropdown;
		...
		WebElement assetMaterialTypeDropdown; 
		...
		public void addAsset(String Facility, String Activity, String Variable,String MaterialType,String ActivityUsage, String EmissionSource, String Unit) throws InterruptedException{
			...
			CommonMethods.clickOn(MaterialsUsed);	
			Thread.sleep(5000);
			...
			Thread.sleep(5000);
			CommonMethods.select(assetMaterialTypeDropdown, MaterialType);
...
//			CommonMethods.clickOn(cancelButton);
		...
		public void assetSaveCancelButton(String Facility, String Variable, String Activity,String MaterialType,String ActivityUsage, String EmissionSource, String Hub) throws InterruptedException {
			...
			if(this.alertPopUpOKButton.isDisplayed()){ 
				...
				CommonMethods.select(materialTypeDropdown, MaterialType);
		...
		public void dataEntry(String From, String To, String Quantity, String Activity,String MaterialType,String ActivityUsage, String EmissionSource, String Hub,String Facility,String Variable) throws InterruptedException{
			...
			Const.logger.info("Data Entry is completed for materials used.");
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is completed for materials used.");
			}
			else {
		...
		public void updateNVerifyData(String ExistFrom, String ExistTo,String Quantity,String From, String To, String Activity,String MaterialType,String ActivityUsage, String EmissionSource,String Hub,String Facility,String Variable) throws InterruptedException {
		...
		public void dataDelete(String Activity,String MaterialType,String ActivityUsage, String EmissionSource, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			ReportUtils.test.log(LogStatus.PASS, alertMsg);
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Data Entry is deleted for Materials Used.");
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is deleted for Materials Used.");
			}
			else {
				Const.logger.info("Asset data does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset data does not exist.");
		...
		public void assetDelete(String Activity,String MaterialType,String ActivityUsage, String EmissionSource, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			ReportUtils.test.log(LogStatus.PASS, alertMsg);
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Asset is deleted succcessfully for Materials Used.");
			ReportUtils.test.log(LogStatus.INFO, "Asset is deleted succcessfully for Materials Used.");
			}
			else {
				Const.logger.info("Asset does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset does not exist.");
