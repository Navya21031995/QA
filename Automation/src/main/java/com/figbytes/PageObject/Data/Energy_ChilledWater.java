...
public class Energy_ChilledWater {
	WebDriver driver;
	JavascriptExecutor executor;
	//private WebDriverWait wait40;
	SoftAssert Assert;

		public Energy_ChilledWater(WebDriver driver){
		...
		@FindBy(id="ddlChilledWaterFuelType")
		WebElement fuelTypeAssetDropdown; 
		...
		public void addAsset(String Facility, String Activity, String Variable,String FuelType, String Unit ) throws InterruptedException{
			...
			Thread.sleep(5000);
			CommonMethods.select(fuelTypeAssetDropdown, FuelType);
...
//			CommonMethods.clickOn(cancelButton);
		...
		public void assetSaveCancelButton(String Facility,String Variable,String Activity,String FuelType,String Hub) throws InterruptedException {
			 ...
			 if(this.alertPopUpOKButton.isDisplayed()){ 
					...
					CommonMethods.select(fuelTypeDropdown, FuelType);	
		...
		public void dataEntry(String From, String To, String Quantity, String Activity,String FuelType,String Hub,String Facility,String Variable) throws InterruptedException{			
	        ...
	        Const.logger.info(formattedNumberWithComma);
			...
			Const.logger.info("Data Entry is completed for Chilled Water.");
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is completed for Chilled Water.");
			}
			else {
		...
		public void updateNVerifyData(String ExistFrom, String ExistTo, String Quantity,String From,String To, String Activity,String FuelType,String Hub,String Facility,String Variable) throws InterruptedException {
		...
		public void dataDelete(String Activity,String FuelType, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			ReportUtils.test.log(LogStatus.PASS, alertMsg);
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Data Entry is deleted for Chilled Water.");
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is deleted for Chilled Water.");
			}
			else {
				Const.logger.info("Asset data does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset data does not exist.");
		...
		public void assetDelete(String Activity,String FuelType, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			CommonMethods.clickOn(alertPopUpOKButton);
			//driver.navigate().refresh();			
			Const.logger.info("Asset is deleted succcessfully for Chilled Water.");
			ReportUtils.test.log(LogStatus.INFO, "Asset is deleted successfully for Chilled Water.");
			}
			else {
				Const.logger.info("Asset does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset does not exist.");
