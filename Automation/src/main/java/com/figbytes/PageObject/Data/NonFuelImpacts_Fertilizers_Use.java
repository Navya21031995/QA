...
public class NonFuelImpacts_Fertilizers_Use {
	...
	SoftAssert Assert;
		...
		public NonFuelImpacts_Fertilizers_Use(WebDriver driver){
		...
		@FindBy(xpath="//ul[@class='col-sm-4 list-unstyled']//a[text()='"+Const.FERTILIZERS_USE_SUB_MENU+"']")
		WebElement FertilizersUse;
		...
		WebElement fertilizerTypeDropdown;
		...
		@FindBy(xpath="//select[@id='ddldropdown1']//option[contains(text(),'Fertilizers')]")
		WebElement assetByFertilizers;
		...
		WebElement assetFertilizerTypeDropdown; 
		
		@FindBy(xpath="//select[@id='ddldropdown2']")
		WebElement assetEmissionSourceFnHDropdown;
		...
		@FindBy(id="txtFertilizerPerc")
		WebElement assetFertilizerPercentageTextBox;
		...
		@FindBy(xpath="//select[contains(@id,'ddlFilter_')][1]//option[contains(text(),'Fertilizers')]")
		WebElement byFertilizers;
		
		public void addAsset(String Facility, String Activity, String Variable,String ActivityUsage,String FertilizerType, String EmissionSource, String Unit, String FertilizerPercentage) throws InterruptedException{
			...
			CommonMethods.clickOn(FertilizersUse);	
			Thread.sleep(5000);
			...
			String activityOrUsage = ActivityUsage;
			CommonMethods.clickOn(activityDropdown);
			String assetFertilizers = assetByFertilizers.getText();
			
			if(activityOrUsage.equals(assetFertilizers)) {			
			Thread.sleep(5000);
			CommonMethods.select(assetActivityUsageDropdown, ActivityUsage);
			CommonMethods.select(assetFertilizerTypeDropdown, FertilizerType);
			Thread.sleep(5000);
			CommonMethods.select(assetEmissionSourceDropdown, EmissionSource);
			Thread.sleep(5000);			
			CommonMethods.select(measurementUNit, Unit);
			Thread.sleep(3000);
			CommonMethods.enterText(assetFertilizerPercentageTextBox, FertilizerPercentage);
			Thread.sleep(3000);
...
//			CommonMethods.clickOn(cancelButton);
				...
				CommonMethods.select(assetActivityUsageDropdown, ActivityUsage);
				Thread.sleep(3000);
				CommonMethods.select(assetEmissionSourceFnHDropdown, EmissionSource);
				Thread.sleep(5000);			
				CommonMethods.select(measurementUNit, Unit);
				Thread.sleep(3000);
				CommonMethods.enterText(assetFertilizerPercentageTextBox, FertilizerPercentage);
		...
		public void assetSaveCancelButton(String Facility, String Variable, String Activity,String ActivityUsage,String FertilizerType, String EmissionSource, String Hub) throws InterruptedException {
			...
			if(this.alertPopUpOKButton.isDisplayed()){ 
				...
				if(this.fertilizerTypeDropdown.isDisplayed()) {
					CommonMethods.select(fertilizerTypeDropdown, FertilizerType);
					} else {
						Const.logger.info("Fertilizers Type dropdown does not exist.");
					}
		...
		public void dataEntry(String From, String To, String Quantity, String Activity,String ActivityUsage,String FertilizerType, String EmissionSource, String Hub,String Facility,String Variable) throws InterruptedException{
			...
			Const.logger.info("Data Entry is completed for Fertilizers Use.");
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is completed for Fertilizers Use.");
			}
			else {
		...
		public void updateNVerifyData(String ExistFrom, String ExistTo,String Quantity,String From, String To, String Activity,String ActivityUsage,String FertilizerType, String EmissionSource,String Hub,String Facility,String Variable) throws InterruptedException {
			...
			if(this.fertilizerTypeDropdown.isDisplayed()) {
				CommonMethods.select(fertilizerTypeDropdown, FertilizerType);
					...
					Const.logger.info("Fertilizers Type dropdown does not exist.");
					ReportUtils.test.log(LogStatus.INFO, "Fertilizers Type dropdown does not exist.");
				}
		...
		public void dataDelete(String Activity,String ActivityUsage,String FertilizerType, String EmissionSource, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			ReportUtils.test.log(LogStatus.PASS, alertMsg);
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Data Entry is deleted for Fertilizers Use.");
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is deleted for Fertilizers Use.");
			}
			else {
				Const.logger.info("Asset data does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset data does not exist.");
		...
		public void assetDelete(String Activity,String ActivityUsage,String FertilizerType, String EmissionSource, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			ReportUtils.test.log(LogStatus.PASS, alertMsg);
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Asset is deleted succcessfully for Fertilizers Use.");
			ReportUtils.test.log(LogStatus.INFO, "Asset is deleted succcessfully for Fertilizers Use.");
			}
			else {
				Const.logger.info("Asset does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset does not exist.");
