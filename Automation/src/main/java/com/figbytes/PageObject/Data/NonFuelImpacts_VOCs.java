...
public class NonFuelImpacts_VOCs {
	...
	SoftAssert Assert;
		...
		public NonFuelImpacts_VOCs(WebDriver driver){
		...
		@FindBy(xpath="//ul[@class='col-sm-4 list-unstyled']//a[text()='"+Const.VOCS_SUB_MENU+"']")
		WebElement VOCs;
		...
		@FindBy(id="txtDensity")
		WebElement assetDensityOrGallonTextBox;

		@FindBy(id=CommonLocators.ADD_ASSET_MEASUREMENT_UNIT)
		WebElement measurementUNit;
		
		@FindBy(id="txtVOCPercent")
		WebElement assetVOCPercentTextBox;
		
		@FindBy(id="txtToluenePercent")
		WebElement assetTolueneTextBox;
		
		@FindBy(id="txtXylenePercent")
		WebElement assetXyleneTextBox;
		
		@FindBy(id="txtFormaldehydePercent")
		WebElement assetFormaldehydeTextBox;
		
		@FindBy(id="txtMEKPercent")
		WebElement assetMEKTextBox;
		...
		public void addAsset(String Facility, String Activity, String Variable,String ActivityUsage, String EmissionSource,String DensityOrGallon,String Unit,String VOC,String Toluene,String Xylene,String Formaldehyde,String MEK ) throws InterruptedException{
			...
			Thread.sleep(5000);	
			CommonMethods.enterText(assetDensityOrGallonTextBox, DensityOrGallon);
			CommonMethods.select(measurementUNit, Unit);
			CommonMethods.enterText(assetVOCPercentTextBox, VOC);
			CommonMethods.enterText(assetTolueneTextBox, Toluene);
			CommonMethods.enterText(assetXyleneTextBox, Xylene);
			CommonMethods.enterText(assetFormaldehydeTextBox, Formaldehyde);
			CommonMethods.enterText(assetMEKTextBox, MEK);
			Thread.sleep(5000);
...
//			CommonMethods.clickOn(cancelButton);
		...
		public void dataEntry(String From, String To, String Quantity, String Activity, String Hub,String Facility,String Variable) throws InterruptedException{
			...
			Const.logger.info("Data Entry is completed for VOCs.");
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is completed for VOCs.");
			}
			else {
		...
		public void dataDelete(String Activity, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			ReportUtils.test.log(LogStatus.PASS, alertMsg);
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Data Entry is deleted for VOCs.");
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is deleted for VOCs.");
			}
			else {
				Const.logger.info("Asset data does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset data does not exist.");
		...
		public void assetDelete(String Activity, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			ReportUtils.test.log(LogStatus.PASS, alertMsg);
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Asset is deleted succcessfully for VOCs.");
			ReportUtils.test.log(LogStatus.INFO, "Asset is deleted succcessfully for VOCs.");
			}
			else {
				Const.logger.info("Asset does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset does not exist.");
