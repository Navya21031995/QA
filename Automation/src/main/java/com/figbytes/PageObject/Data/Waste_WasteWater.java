...
public class Waste_WasteWater {
	...
	SoftAssert Assert;
		...
		public Waste_WasteWater(WebDriver driver){
		...
		@FindBy(xpath="//ul[@class='col-sm-4 list-unstyled']//a[text()='"+Const.WASTE_WATER_SUB_MENU+"']")
		WebElement wasteWater;
		...
		@FindBy(id="ddlIndustry")
		WebElement industryCategoryDropdown; 

		@FindBy(id="ddlType")
		WebElement assetTypeDropdown; 

		@FindBy(id="ddlSubType")
		WebElement assetSubTypeDropdown; 

		@FindBy(id="ddlTreatment")
		WebElement assetTreatmentDropdown; 
		...
		@FindBy(xpath="//div[@id='tblCarbonEmissionData']//table//th[6]//a[@class='k-grid-filter']")
		...
		@FindBy(xpath="//div[@id='tblCarbonEmissionData']//table//th[9]//a[@class='k-grid-filter']")
		WebElement fromDateFilter;
		
		@FindBy(xpath="//div[@id='tblCarbonEmissionData']//table//th[10]//a[@class='k-grid-filter']")
		...
		@FindBy(how=How.XPATH, using = "//div[@id='tblCarbonEmissionData']//tr//td[6]" )
		List<WebElement> assetsShowTable;
		
		public void addAsset(String Facility, String Activity, String Variable,String Industry,String Type, String SubType,String Treatment, String Unit) throws InterruptedException{
			...
			CommonMethods.clickOn(wasteWater);	
			Thread.sleep(5000);
			...
			Thread.sleep(5000);
			CommonMethods.select(industryCategoryDropdown, Industry);
			CommonMethods.select(assetTypeDropdown, Type);
			Thread.sleep(5000);
			CommonMethods.select(assetSubTypeDropdown, SubType);
			Thread.sleep(5000);
			CommonMethods.select(assetTreatmentDropdown, Treatment);			
...
//			CommonMethods.clickOn(cancelButton);			
		...
		public void assetSaveCancelButton(String Facility, String Variable, String Activity,String Industry,String Type, String SubType,String Treatment, String Hub) throws InterruptedException {
			...
			if(this.alertPopUpOKButton.isDisplayed()){ 
				...
				CommonMethods.select(industryDropdown, Industry);
				CommonMethods.select(typeDropdown, Type);
				CommonMethods.select(subTypeDropdown, SubType);
				CommonMethods.select(treatmentDropdown, Treatment);
		...
		public void dataEntry(String From, String To, String Quantity, String Activity,String Industry,String Type, String SubType,String Treatment, String Hub,String Facility,String Variable) throws InterruptedException{
			...
			Const.logger.info("Data Entry is completed for Waste Water.");
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is completed for Waste Water.");
			}
			else {
		...
		public void updateNVerifyData(String ExistFrom, String ExistTo, String Quantity,String From,String To, String Activity,String Industry,String Type, String SubType,String Treatment,String Hub,String Facility,String Variable) throws InterruptedException {
		...
		public void dataDelete(String Activity,String Industry,String Type, String SubType,String Treatment, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			ReportUtils.test.log(LogStatus.PASS, alertMsg);
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Data Entry is deleted for Waste Water.");
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is deleted for Waste Water.");
			}
			else {
				Const.logger.info("Asset data does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset data does not exist.");
		...
		public void assetDelete(String Activity,String Industry,String Type, String SubType,String Treatment, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			ReportUtils.test.log(LogStatus.PASS, alertMsg);
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Asset is deleted succcessfully for Waste Water.");
			ReportUtils.test.log(LogStatus.INFO, "Asset is deleted succcessfully for Waste Water.");
			}
			else {
				Const.logger.info("Asset does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset does not exist.");
