...
//	private WebDriverWait wait10;
	...
	SoftAssert Assert;
		...
		public Transport_Public(WebDriver driver){
...
//		    this.wait10 = new WebDriverWait(driver, 10);
		...
		@FindBy(xpath="//ul[@class='col-sm-4 list-unstyled']//a[text()='"+Const.PUBLIC_SUB_MENU+"']")
		WebElement Public;
		...
		@FindBy(id="ddlSubcategory")
		WebElement mobileTypeAssetDropdown;
		
		@FindBy(id="ddlMobileType")
		WebElement mobileSubTypeAssetDropdown;
		...
		public void addAsset(String Facility, String Activity, String Variable,String MobileSource,String MobileType,String MobileSubType, String Unit ) throws InterruptedException{
			...
			Thread.sleep(5000);
			CommonMethods.select(mobileSubTypeAssetDropdown, MobileSubType);
...
//			CommonMethods.clickOn(cancelButton);
			...
			public void assetSaveCancelButton( String Facility,String Variable, String Activity,String MobileSource,String MobileSubType,String Hub) throws InterruptedException {
				...
				if (this.alertPopUpOKButton.isDisplayed()){ 
					...
					CommonMethods.select(mobileTypeDropdown, MobileSubType);			
			...
			public void dataEntry(String From, String To, String Quantity, String Activity,String MobileSource,String MobileSubType,String Hub,String Facility, String Variable) throws InterruptedException{
				...
				Const.logger.info("Data Entry is completed for Public.");	
				ReportUtils.test.log(LogStatus.INFO, "Data Entry is completed for Public.");
				}
				else {
		...
		public void updateNVerifyData(String ExistFrom, String ExistTo,String Quantity,String From, String To, String Activity,String MobileSource,String MobileSubType,String Hub,String Facility, String Variable) throws InterruptedException {
		...
		public void dataDelete(String Activity,String MobileSource,String MobileSubType, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			ReportUtils.test.log(LogStatus.PASS, alertMsg);
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Data Entry is deleted for public.");
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is deleted for public.");
			}
			else {
				Const.logger.info("Asset data does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset data does not exist.");
		...
		public void assetDelete(String Activity,String MobileSource,String MobileSubType, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			ReportUtils.test.log(LogStatus.PASS, alertMsg);
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Asset is deleted succcessfully for Public.");
			ReportUtils.test.log(LogStatus.INFO, "Asset is deleted succcessfully for Public.");
			}
			else {
				Const.logger.info("Asset does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset does not exist.");
