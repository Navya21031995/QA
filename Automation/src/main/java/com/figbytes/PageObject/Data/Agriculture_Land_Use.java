...
public class Agriculture_Land_Use {
	...
	SoftAssert Assert;
		...
		public Agriculture_Land_Use(WebDriver driver){
		...
		@FindBy(xpath="//ul[@class='col-sm-4 list-unstyled']//a[text()='"+Const.LAND_USE_SUB_MENU+"']")
		WebElement LandUse;
		...
		WebElement existingUseDropdown;
		
		@FindBy(xpath=CommonLocators.CATEGORY_DROPDOWN_2)
		WebElement changeToDropdown;
		...
		WebElement assetExistingUseDropdown; 

		@FindBy(id=CommonLocators.ADD_ASSET_DROPDOWN_2)
		WebElement assetChangeToDropdown;  
		...
		public void addAsset(String Facility, String Activity, String Variable,String ExistingUse,String ChangeTo, String Unit) throws InterruptedException{
			...
			Thread.sleep(5000);
			CommonMethods.select(assetExistingUseDropdown, ExistingUse);
			CommonMethods.select(assetChangeToDropdown, ChangeTo);
			Thread.sleep(5000);		
...
//			CommonMethods.clickOn(cancelButton);
		...
		public void assetSaveCancelButton(String Facility, String Variable, String Activity,String ExistingUse,String ChangeTo, String Hub) throws InterruptedException {
			...
			if(this.alertPopUpOKButton.isDisplayed()){ 
				...
				CommonMethods.select(existingUseDropdown, ExistingUse);
				CommonMethods.select(changeToDropdown, ChangeTo);
		...
		public void dataEntry(String From, String To, String Quantity, String Activity,String ExistingUse,String ChangeTo, String Hub,String Facility,String Variable) throws InterruptedException{
			...
			Const.logger.info("Data Entry is completed for Land Use.");
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is completed for Land Use.");
			}
			else {
		...
		public void updateNVerifyData(String ExistFrom, String ExistTo,String Quantity,String From, String To, String Activity,String ExistingUse,String ChangeTo,String Hub,String Facility,String Variable) throws InterruptedException {
		...
		public void dataDelete(String Activity,String ExistingUse,String ChangeTo, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			ReportUtils.test.log(LogStatus.PASS, alertMsg);
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Data Entry is deleted for Land Use.");
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is deleted for Land Use.");
			}
			else {
				Const.logger.info("Asset data does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset data does not exist.");
		...
		public void assetDelete(String Activity,String ExistingUse,String ChangeTo, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			ReportUtils.test.log(LogStatus.PASS, alertMsg);
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Asset is deleted succcessfully for Land Use.");
			ReportUtils.test.log(LogStatus.INFO, "Asset is deleted successfully for Land Use.");
			}
			else {
				Const.logger.info("Asset does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset does not exist.");
