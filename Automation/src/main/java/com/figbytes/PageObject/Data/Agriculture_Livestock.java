...
public class Agriculture_Livestock {
	...
	SoftAssert Assert;
		...
		public Agriculture_Livestock(WebDriver driver){
		...
		@FindBy(xpath="//ul[@class='col-sm-4 list-unstyled']//a[text()='"+Const.LIVESTOCK_SUB_MENU+"']")
		WebElement Livestock;
		...
		@FindBy(xpath=CommonLocators.FUEL_TYPE_DROPDOWN)
		WebElement livestockTypeDropdown;
		...
		@FindBy(xpath="//div[@id='tblDataAddLS']//tr[1]/td//input[contains(@id,'txtDateFrom_')]")
		WebElement dateFromText;
				
		@FindBy(xpath="//div[@id='tblDataAddLS']//tr[1]/td//input[contains(@id,'txtDateTo_')]")
		WebElement dateToText;
		
		@FindBy(xpath="//div[@id='tblDataAddLS']//tr[1]/td//input[contains(@id,'txtQuantity_')]")
		WebElement quantityText;
		
		@FindBy(xpath="//div[@id='tblDataAddLS']//tr[1]/td//input[contains(@id,'txtNotes_')]")
		WebElement notesText;
		
		@FindBy(xpath="//div[@id='tblDataAddLS']//tr[1]/td//i[contains(@id,'btnSave_')]")
		...
		@FindBy(xpath="//div[@id='tblDataShowLS']//tr[1]/td//label[@id[contains(.,'lblDateFromEdit')]]")
		WebElement expectedDateFrom;
		
		@FindBy(xpath="//div[@id='tblDataShowLS']//tr[1]/td//label[@id[contains(.,'lblDateToEdit_')]]")
		WebElement expectedDateTo;
		
		@FindBy(xpath="//div[@id='tblDataShowLS']//tr[1]/td//label[@id[contains(.,'lblQuantityEdit_')]]")
		WebElement expectedQty;
		
		@FindBy(xpath="//div[@id='tblDataShowLS']//tr[1]/td//i[contains(@id,'btnEdit_')]")
		WebElement editButton;
		
		@FindBy(xpath="//div[@id='tblDataShowLS']//tr[1]/td//input[contains(@id,'txtDateFromEdit_')]")
		WebElement editDateFromTextBox;
		
		@FindBy(xpath="//div[@id='tblDataShowLS']//tr[1]/td//input[contains(@id,'txtDateToEdit_')]")
		WebElement editDateToTextBox;
		
		@FindBy(xpath="//div[@id='tblDataShowLS']//tr[1]/td//input[@id[contains(.,'txtQuantityEdit_')]]")
		WebElement editQty;
		
		@FindBy(xpath="//div[@id='tblDataShowLS']//tr[1]/td//input[@id[contains(.,'txtNotesEdit_')]]")
		WebElement editNotesText;
		
		@FindBy(xpath="//div[@id='tblDataShowLS']//tr[1]/td//i[@id[contains(.,'btnEditSave_')]]")
		...
		@FindBy(id="ddlLSType")
		WebElement livestockTypeAssetDropdown;
		
		@FindBy(id="txtLivestockNum")
		WebElement numberOfLivestockAssetTextBox;
		
		@FindBy(id="txtLiquidSystemsPercent")
		WebElement liquidSystemsAssetTextBox;
		
		@FindBy(id="txtSolidstoragenandDrylotPercent")
		WebElement solidStorageNDrylotAssetTextBox;
		
		@FindBy(id="txtPastureRangePaddockPercent")
		WebElement pastureRangePaddockAssetTextBox;
		
		@FindBy(id="txtOtherSystems")
		WebElement otherSystemsAssetTextBox;
		...
		@FindBy(xpath="//div[@id='tblDataShowLS']//tr[1]/td//label[contains(@for,'chkAllArchive_')]")
		WebElement archiveCheckbox;
		
		@FindBy(xpath="//div[@id='tblDataShowLS']//tr[1]/td//label[contains(@for,'chkAllDelete_')]")
		...
		@FindBy(xpath="//div[@id='tblDataShowLS']//table//th[7]//a[@class='k-grid-filter']")
		...
		@FindBy(xpath="//div[@id='tblDataAddLS']//tr[1]/td//label[contains(@for,'chkAllDeleteAsset_')]")
		WebElement deleteAssetCheckBox;
		
		@FindBy(id=CommonLocators.ASSET_DELETE_BUTTON)
		WebElement deleteAssetButton;
	
		@FindBy(xpath="//div[@id='tblDataShowLS']//table//th[10]//a[@class='k-grid-filter']")
		WebElement fromDateFilter;
		
		@FindBy(xpath="//div[@id='tblDataShowLS']//table//th[11]//a[@class='k-grid-filter']")
		WebElement toDateFilter;
		
		@FindBy(xpath=CommonLocators.DATE_FILTER_TEXT_BOX)
		WebElement dateFilterTextBox;
		
		@FindBy(xpath="//div[@id='tblDataAddLS']//table//th[4]//a[@class='k-grid-filter']")
		WebElement dataAddEnteredAt;
		
		@FindBy(xpath="//div[@id='tblDataAddLS']//table//th[7]//a[@class='k-grid-filter']")
		WebElement dataEntryVariableFilter;
		
		@FindBy(xpath="//div[@id='tblDataAddLS']//tr[1]//td//a[@class='clsInputControl']")
		WebElement expectedVariableAsset;
			
		@FindBy(how=How.XPATH, using =  "//div[@id='tblDataAddLS']//tr//td[7]")
		List<WebElement> assetsAddTable;
		
		@FindBy(xpath="//div[@id='tblDataShowLS']//table//th[4]//a[@class='k-grid-filter']")
		WebElement dataShowEnteredAt;
		
		@FindBy(how=How.XPATH, using = "//div[@id='tblDataShowLS']//tr//td[7]" )
		List<WebElement> assetsShowTable;
		
		public void addAsset(String Facility, String Activity, String Variable,String LivestockType, String Unit,String NumberOfLivestock, String LiquidSystems,String SolidStorageDrylot,String PastureRangePaddock,String OtherSystems) throws InterruptedException{
			...
			CommonMethods.clickOn(Livestock);			
			Thread.sleep(5000);
			...
			Thread.sleep(5000);
			CommonMethods.select(livestockTypeAssetDropdown, LivestockType);
			CommonMethods.select(measurementUNit, Unit);	
	        CommonMethods.enterText(numberOfLivestockAssetTextBox, NumberOfLivestock);
			CommonMethods.enterText(liquidSystemsAssetTextBox, LiquidSystems);
			CommonMethods.enterText(solidStorageNDrylotAssetTextBox, SolidStorageDrylot);
			CommonMethods.enterText(pastureRangePaddockAssetTextBox, PastureRangePaddock);
			CommonMethods.enterText(otherSystemsAssetTextBox, OtherSystems);			
			Thread.sleep(3000);
...
//			CommonMethods.clickOn(cancelButton);
		...
		public void assetSaveCancelButton(String Facility,String Variable,String Activity,String LivestockType,String Hub) throws InterruptedException {
			...
			if(this.alertPopUpOKButton.isDisplayed()){ 
				...
				CommonMethods.select(livestockTypeDropdown, LivestockType);
		...
		public void dataEntry(String From, String To, String Quantity, String Activity,String LivestockType,String Hub,String Facility,String Variable) throws InterruptedException{
			...
			Thread.sleep(5000);
			CommonMethods.clear(quantityText);
			...
			Const.logger.info("Data Entry is completed for Livestock.");
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is completed for Livestock.");
			}
			else {
	...
	public void updateNVerifyData(String ExistFrom, String ExistTo,String Quantity,String From, String To, String Activity,String LivestockType,String Hub,String Facility,String Variable) throws InterruptedException {
		...
		public void dataDelete(String Activity,String LivestockType, String Hub, String Facility,String Variable) throws InterruptedException {
			...
			ReportUtils.test.log(LogStatus.PASS, alertMsg);
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Data Entry is deleted for Livestock.");
			ReportUtils.test.log(LogStatus.INFO, "Data Entry is deleted for Livestock.");
			}
			else {
				Const.logger.info("Asset data does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset data does not exist.");
	...
	public void assetDelete(String Activity,String LivestockType, String Hub, String Facility, String Variable) throws InterruptedException {
			...
			ReportUtils.test.log(LogStatus.PASS, alertMsg);
			CommonMethods.clickOn(alertPopUpOKButton);
			Const.logger.info("Asset is deleted succcessfully for Livestock.");
			ReportUtils.test.log(LogStatus.INFO, "Asset is deleted successfully for Livestock.");
			}
			else {
				Const.logger.info("Asset does not exist.");
				ReportUtils.test.log(LogStatus.INFO, "Asset does not exist.");
